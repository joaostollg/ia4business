...
> Versão refinada do [prompt-ma-telecom-v2.md](prompt-ma-telecom-v2.md), depois de uma crítica de "revisor exigente" (o que estava ambíguo, o que faltava, o que sobrava). Ainda não foi executada — é só o texto do prompt reescrito, para uso futuro em [problema.md](problema.md).
